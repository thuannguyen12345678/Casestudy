                                                        ...
                                                        <tr>
                                                            <td class="si-pic">
                                                                <img style="width:80px ; height:80px;"
                                                                    src="{{ asset('public/uploads/product/' . $details['img']) }}">
                                                            </td>
                                                            <td class="si-text">
                            ...
                            @foreach ($products as $prd)
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            <img
                                                src="public/uploads/product/{{ $prd->image }}"style="height:350px; width:200px">
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/profile.php?id=100080717106514"><i
